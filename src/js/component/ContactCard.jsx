        ...
        <div className="row g-0">
          ...
          <div className="col-md-4">
            <div className="contact-info mt-4 pt-4 pb-0">
              <p className="contact-name text-start fs-2">{name}</p>
              <p className="contact-address text-start text-secondary fs-4">
                <svg
              ...
              <p className="contact-phone text-start text-secondary fs-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
              ...
              <p className="contact-email text-start text-secondary fs-5">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
            ...
            <div className="modal-dialog">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  Are you sure you want to delete this contact? This step cannot
                  be undone.
                </div>
